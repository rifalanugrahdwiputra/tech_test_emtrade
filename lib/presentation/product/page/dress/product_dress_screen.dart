...
class ProductDressScreen extends StatelessWidget {
  const ProductDressScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<ProductCubit>()..getContent(),
      child: const ProductDressScreenPage(),
    );
  }
}

class ProductDressScreenPage extends StatefulWidget {
  const ProductDressScreenPage({super.key});

  @override
  State<ProductDressScreenPage> createState() => _ProductDressScreenPageState();
}

class _ProductDressScreenPageState extends State<ProductDressScreenPage> {
  @override
  void initState() {
    super.initState();
