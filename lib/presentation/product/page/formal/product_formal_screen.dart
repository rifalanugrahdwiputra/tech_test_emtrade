...
class ProductFormalScreen extends StatelessWidget {
  const ProductFormalScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<ProductCubit>()..getContent(),
      child: const ProductFormalScreenPage(),
    );
  }
}

class ProductFormalScreenPage extends StatefulWidget {
  const ProductFormalScreenPage({super.key});

  @override
  State<ProductFormalScreenPage> createState() => _ProductFormalScreenPageState();
}

class _ProductFormalScreenPageState extends State<ProductFormalScreenPage> {
  @override
  void initState() {
    super.initState();
