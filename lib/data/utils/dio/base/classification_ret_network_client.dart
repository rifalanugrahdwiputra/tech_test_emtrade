...
@lazySingleton
class ClassificationRetApiDio extends DioForNative {
  ClassificationRetApiDio() {
    _configureOptions();
    _configureInterceptors();
  }

  void _configureOptions() async {
    options.baseUrl = FAEnvironment().classificationUrl;
...
@module
abstract class BaseClassificationRetrofitInjectableModule {
  ClassificationRemoteService getClassificationRemoteService(
          ClassificationRetApiDio client) =>
      ClassificationRemoteService(client);
}
